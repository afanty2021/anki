...
<cite>
**本文档中引用的文件**  
- [backend.proto](file://proto/anki/backend.proto) - *更新于最近提交*
- [_backend.py](file://pylib/anki/_backend.py) - *错误处理逻辑更新*
- [errors.py](file://pylib/anki/errors.py) - *Python异常类定义*
- [lib.rs](file://pylib/rsbridge/lib.rs) - *PyO3桥接实现*
- [mod.rs](file://rslib/src/error/mod.rs) - *Rust核心错误枚举*
- [network.rs](file://rslib/src/error/network.rs) - *网络错误类型定义*
- [db.rs](file://rslib/src/error/db.rs) - *数据库错误类型定义*
- [backend/error.rs](file://rslib/src/backend/error.rs) - *Protobuf错误转换逻辑*
</cite>
